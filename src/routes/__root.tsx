...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CA Mentor — AI-Powered CA Exam Preparation" },
      { name: "description", content: "Master the ICAI CA Foundation, Intermediate, and Final exams with an AI teacher, RAG-grounded answers, and a personal syllabus tracker." },
    ],
    links: [
